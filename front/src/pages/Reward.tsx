    ...
    <div className="relative px-6 pt-10 pb-10 min-h-full">
      ...
      <div className="relative text-center">
        <div className="relative mx-auto w-32 h-32 grid place-items-center">
          ...
          <span
            className="absolute inset-3 rounded-full bg-michelin-yellow/40 pulse-ring"
        ...
        <div className="mt-6 text-[11px] uppercase tracking-[0.2em] font-bold text-primary">
        ...
        <p className="mt-2 text-sm text-muted-foreground max-w-[280px] mx-auto">
          Vous avez débloqué <span className="text-ink font-bold">−15%</span>{" "}
          sur les pneus Michelin Power Cup.
        </p>
        ...
        <button
          onClick={onSee}
          className="mt-8 w-full h-14 rounded-2xl bg-primary text-primary-foreground font-semibold text-[15px] shadow-[var(--shadow-elevated)]"
        >
          Voir mon offre
        </button>
      </div>
