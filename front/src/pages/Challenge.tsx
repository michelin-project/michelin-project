export function Challenge({
  ...
  return (
    <div className="px-6 pt-4 pb-10">
      <button
        onClick={onBack}
        className="text-sm text-muted-foreground mb-4 flex items-center gap-1.5"
      >
        <svg
          viewBox="0 0 24 24"
          fill="none"
      ...
      <h1 className="mt-1 text-[30px] font-black tracking-tight leading-tight">
        Roulez 200 km en mai
      </h1>

      <div className="mt-5 rounded-3xl border border-border overflow-hidden">
        <div className="p-5 bg-linear-to-br from-michelin-yellow/40 to-michelin-yellow/10">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-[11px] uppercase tracking-wider font-bold text-ink">
                Récompense
              </div>
              <div className="text-xl font-black tracking-tight mt-0.5">
                −15% sur Michelin Power Cup
              </div>
            </div>
          ...
          <div className="flex items-end justify-between">
            <div>
              <div className="text-3xl font-black tracking-tight">
                0
                <span className="text-base text-muted-foreground">/200 km</span>
              </div>
              <div className="text-[11px] text-muted-foreground mt-1">
                Démarre dès votre première sortie
              </div>
            </div>
      ...
      <div className="mt-6 rounded-2xl border border-border p-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-[#FC4C02] grid place-items-center text-white font-black">
            S
          </div>
          <div className="flex-1">
            ...
            <div className="text-[11px] text-muted-foreground">
              {ready
                ? "Compte lié — prêt à rouler"
                : "Requis pour rejoindre le challenge"}
            </div>
          </div>
          {ready ? (
            ...
            <button
              onClick={onLink}
              className="rounded-full bg-[#FC4C02] text-white text-xs font-semibold px-3 py-2"
            >
              Connecter
            </button>
          )}
